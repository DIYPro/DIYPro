								...
								<table class="table"
									...
									<thead>
										<tr>
											...
											<th style="WIDTH: 10%;">COMPANYID</th>
											<th style="WIDTH: 10%;">MANAGERNAME</th>
											<th style="WIDTH: 13%;">MANAGERDEPT</th>
											<th style="WIDTH: 20%;">MANAGEREMAIL</th>
											<th style="WIDTH: 7%;">AUTHORITY</th>
										</tr>
									</thead>
									<tbody>
										...
										<form class="form-inline" style="text-align: center;"
											...
											<div class="sel sel--black-panther"
												...
												<select name="companyCondition" id="companyCondition"
													style="display: none;">
													<option value="coId">CompanyId</option>
													<option value="coManagerEmail">ManagerEmail</option>
												</select>
											</div>
