                                        ...
                                        <h2 style=" color: #555">Sign up</h2><hr>
												...
												<tr class="row">
													<td class="col-md-3" style="width: 50%;"><input
														...
														<input type="text" class="form-control input-lg" id="coManagerDept" name="coManagerDept" placeholder="Department"
														style="margin-bottom: 10px;"> 
														<input type="text" class="form-control input-lg" id="coManagerEmail" name="coManagerEmail" placeholder="Email"
														style="margin-bottom: 10px;"> 
														<input type="button" class="button button--aylen btn" id="checkmail" value="Certify" disabled="disabled"
		...
		$(function(){
			...
			$("#joinCompany").click(function(){
				...
				if(coName.val() == ""){
					alert("회사명을 입력해주세요!");
					return false;
				}else if(coId.val().length < 5){
					alert("아이디는 5글자 이상!");
					return false;
				}else if(coPwd.val().length < 6){
					alert("비밀번호는 6글자 이상!");
					return false;
				}else if(coTel.val() == ""){
					alert("전화번호를 입력해주세요!");
			...
			//이메일 입력 확인
			$("#coManagerEmail").on('keyup', function(){
				var emailin = $("#coManagerEmail").val();
				if(emailin != "") {
					$("#checkmail").removeAttr("disabled");
					$("#joinCompany").attr("disabled", "disabled");
				}
