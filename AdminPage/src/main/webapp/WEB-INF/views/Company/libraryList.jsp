...
<body style="overflow: visible;">
						...
						<div class="tab-pane fade active in" id="step1">
							<div class="shopcart">
								<table class="table"
									...
									<thead>
										<tr>
											<th style="WIDTH: 10%;">FurnitureNum</th>
											<th style="WIDTH: 10%;">CompanyName</th>
											<th style="WIDTH: 15%;">FurnitureName</th>
	...
	<script>
		function pageProc(currentPage, libraryCondition, libraryKeyword){
			...
			location.href = "/admin/file/libraryList?coNAME="+session +"&currentPage="+currentPage + "&libraryCondition="+libraryCondition + "&libraryKeyword="+libraryKeyword;
		}
	</script>
</body>
